...
public final class Lexer202410 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=219;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("defvar","defun","move","skip","turn",":forward",":left",":right",":around","face",":north",":south",":east",":west","put","pick",":balloons",":chips","move-dir",":front",":back","run-dirs","move-face","null","Dim","myXpos","myYpos","myChips","myBalloons","balloonsHere","ChipsHere","Spaces","if","loop","repeat","facing?","blocked?","can-put?","can-pick?","can-move?","isZero?","not")));
      $line=263;
      allSymbols=$cast(ISet.class,$fix(GCollections.asSet("(",")",",","=","?")));
      $line=270;
      ((gold.structures.map.GHashTableMap)translation).put("defvar",'a');
      $line=271;
      ((gold.structures.map.GHashTableMap)translation).put("defun",'b');
      $line=272;
      ((gold.structures.map.GHashTableMap)translation).put("move",'c');
      $line=273;
      ((gold.structures.map.GHashTableMap)translation).put("skip",'d');
      $line=274;
      ((gold.structures.map.GHashTableMap)translation).put("turn",'e');
      $line=275;
      ((gold.structures.map.GHashTableMap)translation).put(":forward",'+');
      $line=276;
      ((gold.structures.map.GHashTableMap)translation).put(":left",'f');
      $line=277;
      ((gold.structures.map.GHashTableMap)translation).put(":right",'g');
      $line=278;
      ((gold.structures.map.GHashTableMap)translation).put(":around",'h');
      $line=279;
      ((gold.structures.map.GHashTableMap)translation).put("face",'i');
      $line=280;
      ((gold.structures.map.GHashTableMap)translation).put(":north",'j');
      $line=281;
      ((gold.structures.map.GHashTableMap)translation).put(":south",'k');
      $line=282;
      ((gold.structures.map.GHashTableMap)translation).put(":east",'l');
      $line=283;
      ((gold.structures.map.GHashTableMap)translation).put(":west",'m');
      $line=284;
      ((gold.structures.map.GHashTableMap)translation).put("put",'n');
      $line=285;
      ((gold.structures.map.GHashTableMap)translation).put("pick",'o');
      $line=286;
      ((gold.structures.map.GHashTableMap)translation).put(":balloons",'p');
      $line=287;
      ((gold.structures.map.GHashTableMap)translation).put(":chips",'q');
      $line=288;
      ((gold.structures.map.GHashTableMap)translation).put("move-dir",'r');
      $line=289;
      ((gold.structures.map.GHashTableMap)translation).put(":front",'s');
      $line=290;
      ((gold.structures.map.GHashTableMap)translation).put(":back",'t');
      $line=291;
      ((gold.structures.map.GHashTableMap)translation).put("run-dirs",'u');
      $line=292;
      ((gold.structures.map.GHashTableMap)translation).put("move-face",'x');
      $line=293;
      ((gold.structures.map.GHashTableMap)translation).put("null",'y');
      $line=294;
      ((gold.structures.map.GHashTableMap)translation).put("Dim",'z');
      $line=295;
      ((gold.structures.map.GHashTableMap)translation).put("myXpos",'0');
      $line=296;
      ((gold.structures.map.GHashTableMap)translation).put("myYpos",'1');
      $line=297;
      ((gold.structures.map.GHashTableMap)translation).put("myChips",'2');
      $line=298;
      ((gold.structures.map.GHashTableMap)translation).put("myBalloons",'3');
      $line=299;
      ((gold.structures.map.GHashTableMap)translation).put("balloonsHere",'4');
      $line=300;
      ((gold.structures.map.GHashTableMap)translation).put("ChipsHere",'5');
      $line=301;
      ((gold.structures.map.GHashTableMap)translation).put("Spaces",'6');
      $line=302;
      ((gold.structures.map.GHashTableMap)translation).put("if",'7');
      $line=303;
      ((gold.structures.map.GHashTableMap)translation).put("loop",'8');
      $line=304;
      ((gold.structures.map.GHashTableMap)translation).put("repeat",'9');
      $line=305;
      ((gold.structures.map.GHashTableMap)translation).put("facing?",'!');
      $line=306;
      ((gold.structures.map.GHashTableMap)translation).put("blocked?",'@');
      $line=307;
      ((gold.structures.map.GHashTableMap)translation).put("can-put?",'$');
      $line=308;
      ((gold.structures.map.GHashTableMap)translation).put("can-pick?",'%');
      $line=309;
      ((gold.structures.map.GHashTableMap)translation).put("can-move?",'&');
      $line=310;
      ((gold.structures.map.GHashTableMap)translation).put("isZero?",'/');
      $line=311;
